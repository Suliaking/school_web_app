    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" name="airtime_amount" placeholder="Enter Airtime Amount" aria-label="Airtime Amount" id="inputGroupAmount04">
                            <button class="btn btn-outline-secondary" type="submit" name="service" value="airtime">Buy</button>
                        </div>
                        </div>
                    </div>
                    </div>
            ...
            <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-body">
                        <h4 class="card-title">Buy Airtime For Friends</h4>
                        <input type="number" class="form-control" name="phonenumber" placeholder="Enter Phone Number" aria-label="Phone Number" id="inputGroupAmount04">
                        <p></p>
                        <input type="number" class="form-control" name="airtime_amount" placeholder="Enter Airtime Amount" aria-label="Airtime Amount" id="inputGroupAmount04">
                        <button class="btn btn-outline-secondary" type="submit" name="service" value="airtime">Buy</button>
                        </div>
