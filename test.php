        ...
        <div class="page-wrapper">
            ...
            <!-- <form method="POST" action="submit_test.php">
                <div class="container mt-4">
                    <h4 class="mb-4">Simple CBT Test</h4>

                     Question 1 
                    <div class="mb-3">
                        <label class="form-label">1. What is 2 + 2?</label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q1" value="3" id="q1a">
                            <label class="form-check-label" for="q1a">3</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q1" value="4" id="q1b">
                            <label class="form-check-label" for="q1b">4</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q1" value="5" id="q1c">
                     ...
                     Question 2 
                    <div class="mb-3">
                        <label class="form-label">2. Capital of France?</label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q2" value="London" id="q2a">
                            <label class="form-check-label" for="q2a">London</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q2" value="Berlin" id="q2b">
                            <label class="form-check-label" for="q2b">Berlin</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q2" value="Paris" id="q2c">
                            <label class="form-check-label" for="q2c">Paris</label>
                        </div>
                    </div>

                     Question 3 
                    <div class="mb-3">
                        <label class="form-label">3. what is 10 + 10?</label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q3" value="40" id="q3a">
                            <label class="form-check-label" for="q3a">40</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q3" value="10" id="q3b">
                            <label class="form-check-label" for="q3b">10</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q3" value="20" id="q3c">
                            <label class="form-check-label" for="q3c">20</label>
                        </div>
                    </div>

                     Question 4 
                    <div class="mb-3">
                        <label class="form-label">4. what is the opposite of good?</label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q4" value="bad" id="q4a">
                            <label class="form-check-label" for="q4a">bad</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q4" value="benevolence" id="q4b">
                            <label class="form-check-label" for="q4b">benevolence</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="q4" value="wicked" id="q4c">
                            <label class="form-check-label" for="q4c">wicked</label>
                        </div>
                    </div>
