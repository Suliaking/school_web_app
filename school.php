...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url(assets/images/big/auth-bg5.jpg) no-repeat center center;">
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(assets/images/big/img7.jpg);">
                </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="text-center mt-2 mb-4">
                                        <a href="index.html" class="text-success">
                                            <span>
                                                <img class="me-2" src="assets/images/logo-icon.png" alt="" height="70">
                                                <img src="assets/images/logo-text.png" alt="" height="100">
                                            </span>
                                        </a>
                                    </div>
                                    <form class="ps-3 pe-3" action="insert.php" method="post">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-select" name="term" id="inputGroupSelect01">
